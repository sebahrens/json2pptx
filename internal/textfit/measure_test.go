...
func TestMeasureRun_ShortTextFitsOneLine(t *testing.T) {
	m := MeasureRun("Hello", "Arial", 18.0, 5*914400, 10)
	if !m.Fits {
...
func TestMeasureRun_LongTextWraps(t *testing.T) {
	...
	m := MeasureRun(text, "Arial", 18.0, 2*914400, 0) // 2 inches wide, unlimited lines
	if m.Lines <= 1 {
...
func TestMeasureRun_OverflowBeyondMaxLines(t *testing.T) {
	...
	m := MeasureRun(text, "Arial", 18.0, 2*914400, 1) // 2 inches, max 1 line
	if m.Fits {
...
func TestMeasureRun_MultibyteCJK(t *testing.T) {
	...
	m := MeasureRun(text, "Arial", 18.0, 2*914400, 0)
	...
	m2 := MeasureRun(text, "Arial", 18.0, 1*914400, 1) // 1 inch, max 1 line
...
func TestMeasureRun_EmptyString(t *testing.T) {
	m := MeasureRun("", "Arial", 18.0, 5*914400, 10)
	if !m.Fits {
...
func TestMeasureRun_ZeroWidth(t *testing.T) {
	m := MeasureRun("Hello", "Arial", 18.0, 0, 10)
	if m.Fits {
...
func TestMeasureRun_ZeroFontSize(t *testing.T) {
	m := MeasureRun("Hello", "Arial", 0, 5*914400, 10)
	if m.Fits {
...
func TestMeasureRun_UnlimitedMaxLines(t *testing.T) {
	...
	m := MeasureRun(long, "Arial", 18.0, 1*914400, 0)
	if !m.Fits {
...
func TestMeasureRun_NegativeMaxLines(t *testing.T) {
	...
	m := MeasureRun("Some text here", "Arial", 18.0, 1*914400, -1)
	if !m.Fits {
...
func TestMeasureRun_RequiredEMUGrowsWithLines(t *testing.T) {
	short := MeasureRun("Hi", "Arial", 18.0, 5*914400, 0)
	long := MeasureRun("This is a much longer text that will wrap to multiple lines in a narrow two inch wide placeholder area", "Arial", 18.0, 2*914400, 0)
...
func TestMeasureRun_PureNoSideEffects(t *testing.T) {
	...
	m1 := MeasureRun(text, "Arial", 18.0, 3*914400, 5)
	m2 := MeasureRun(text, "Arial", 18.0, 3*914400, 5)
	if m1 != m2 {
