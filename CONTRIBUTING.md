...
This is the canonical command reference and session-completion checklist for
working this repo through Beads. AGENTS.md and CLAUDE.md point here instead of
duplicating it, so update this section (not those files) when the workflow
changes.
