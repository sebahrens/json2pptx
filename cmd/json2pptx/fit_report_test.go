...
func TestStrictFit_Off(t *testing.T) {
	...
	err := runJSONMode(jsonPath, outputPath, templatesDir, tmpDir, "", false, false, "", "off", false)
...
func TestStrictFit_Strict_RefusesUnfittable(t *testing.T) {
	...
	templatesDir := filepath.Join("..", "..", "templates")
	err := runJSONMode(jsonPath, outputPath, templatesDir, tmpDir, "", false, false, "", "strict", false)
	if err == nil {
...
func TestStrictFit_Warn_Succeeds(t *testing.T) {
	...
	templatesDir := filepath.Join("..", "..", "templates")
	err := runJSONMode(jsonPath, outputPath, templatesDir, tmpDir, "", false, false, "", "warn", false)
