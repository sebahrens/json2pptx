...
func TestConvertPresentationSlides_PatternAndShapeGridXOR(t *testing.T) {
	...
	_, err := convertPresentationSlides([]SlideInput{slide}, nil, 12192000, 6858000, nil, nil, "")
	if err == nil {
...
func TestConvertPresentationSlides_PatternExpansion(t *testing.T) {
	...
	specs, err := convertPresentationSlides([]SlideInput{slide}, nil, 12192000, 6858000, nil, nil, "")
	if err != nil {
