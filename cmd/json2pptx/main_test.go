...
func TestRunJSONMode_MissingTemplate(t *testing.T) {
	...
	err := runJSONMode(jsonPath, outputPath, tmpDir, tmpDir, "", false, false, "", "off", false, "off")
...
func TestRunJSONMode_NonexistentInput(t *testing.T) {
	...
	err := runJSONMode("/nonexistent/file.json", outputPath, tmpDir, tmpDir, "", false, false, "", "off", false, "off")
...
func TestRunJSONMode_OutputFilenameExtension(t *testing.T) {
	...
	err := runJSONMode(jsonPath, "", tmpDir, tmpDir, "", false, false, "", "off", false, "off")
	if err == nil {
...
func TestRunJSONMode_InvalidConfig(t *testing.T) {
	...
	err := runJSONMode(jsonPath, "", tmpDir, tmpDir, "/nonexistent/config.yaml", false, false, "", "off", false, "off")
	if err == nil {
