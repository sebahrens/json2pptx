...
func mcpToolCatalog() []mcpToolEntry {
	entries := []mcpToolEntry{
		...
		// Tools from 4.24.0
		{Name: "propose_repairs", AddedIn: "4.24.0"},
		// Tools from 4.30.0
		{Name: "describe_finding", AddedIn: "4.30.0"},
		// Tools from 4.32.0
		{Name: "preview_icon", AddedIn: "4.32.0"},
		// Tools from 4.33.0
		{Name: "repair_slides_batch", AddedIn: "4.33.0"},
		// Tools from 4.34.0
		{Name: "auto_repair", AddedIn: "4.34.0"},
		// Tools from 4.35.0
