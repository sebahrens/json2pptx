...
func TestCalibrationDefectClassesAreDetected(t *testing.T) {
	want := map[string]string{
		...
		// go-slide-creator-h339i: B07's defect is semantic — KPIs drawn as a
		// timeline, a four-month plan drawn as a 2x2. It used to be a
		// documented static-path miss; the content-shape check now names it.
		"B07_wrong_pattern": patterns.ErrCodePatternContentMismatch,
	}
