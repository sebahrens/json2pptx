...
| `p-style.pptx` | designer | **No** | PASS | Designer-owned template with canonical layouts and Georgia/Arial theme fonts. Included in the full cross-template test corpus. |
