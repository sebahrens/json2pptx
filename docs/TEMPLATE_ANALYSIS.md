...
| `abstract.pptx` | designer | **No** | FAIL (4 FAIL, 3 WARN) | Designer-owned. Title Slide missing `subtitle`; Two Content, Blank, Blank + Title layouts missing; Section Number placeholder not named. Repair tracked under `go-slide-creator-lenc` (parent `go-slide-creator-vqad`). |
